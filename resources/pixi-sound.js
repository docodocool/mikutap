...
console.log(this);
(this.PIXI = this.PIXI || {}),
  (this.PIXI.sound = (function (t, e, n, o) {
    "use strict";
    var i;
    function r() {
      return i;
    ...
    var a = function () {
      ...
      c = ["mp3", "ogg", "oga", "opus", "mpeg", "wav", "m4a", "aiff", "wma", "mid", "caf"],
      p = {};
    function h(t) {
      var e = a(
          {
      ...
      c.forEach(function (t) {
        var r = n.canPlayType("audio/" + t).replace(i, ""),
          s = e[t] ? n.canPlayType(e[t]).replace(i, "") : "";
        o[t] = !!r || !!s;
      }),
        Object.assign(p, o);
    }
    ...
    function d(t) {
      ...
      for (
        var o = e.exec(n), i = o[2].split(","), r = i[i.length - 1], s = 0, u = i.length;
        s < u;
        s++
      ) {
        var a = i[s];
    ...
    var f = (function () {
        ...
        return (
          (e.add = function () {
            e.setLegacy(r().useLegacy);
          }),
          (e.setLegacy = function (e) {
            var n = c;
            e
              ? n.forEach(function (e) {
                  t.LoaderResource.setExtensionXhrType(
                    e,
                    t.LoaderResource.XHR_RESPONSE_TYPE.DEFAULT
                  ),
                    t.LoaderResource.setExtensionLoadType(e, t.LoaderResource.LOAD_TYPE.AUDIO);
                })
              : n.forEach(function (e) {
                  t.LoaderResource.setExtensionXhrType(
                    e,
                    ...
                    t.LoaderResource.setExtensionLoadType(e, t.LoaderResource.LOAD_TYPE.XHR);
                });
          }),
          (e.pre = function (t, e) {
            d(t), e();
          ...
          (e.use = function (t, e) {
            t.data && c.indexOf(t.extension) > -1
              ? (t.sound = r().add(t.name, { loaded: e, preload: !0, url: t.url, source: t.data }))
              : e();
          }),
          e
        );
        ...
        return (
          ...
          (e.prototype.play = function (t) {
            ...
            (this._speed = s),
              ...
              (this._muted = c),
              this.refresh(),
              this.loop && null !== r && (this.loop = !1),
              (this._start = i),
              (this._end = r || this._duration),
              (this._start = Math.max(0, this._start - e.PADDING)),
              (this._end = Math.min(this._end + e.PADDING, this._duration)),
              (this._source.onloadedmetadata = function () {
                o._source &&
                  ((o._source.currentTime = i),
                  (o._source.onloadedmetadata = null),
                  o.emit("progress", i, o._duration),
                  n.Ticker.shared.add(o._onUpdate, o));
              }),
          ...
          (e.prototype._onComplete = function () {
            n.Ticker.shared.remove(this._onUpdate, this),
              this._internalStop(),
              this.emit("progress", 1, this._duration),
              this.emit("end", this);
          }),
          (e.prototype.destroy = function () {
            n.Ticker.shared.remove(this._onUpdate, this), this.removeAllListeners();
            var t = this._source;
            t && ((t.onended = null), (t.onplay = null), (t.onpause = null), this._internalStop()),
              (this._source = null),
              (this._speed = 1),
              (this._volume = 1),
              (this._loop = !1),
            ...
            if (4 !== e.readyState)
              if (n.url) {
                ...
                var o = function () {
                  ...
                  i = function () {
                    s(), t && t(new Error("Sound loading has been aborted"));
                  },
                  r = function () {
                    s();
                ...
                e.addEventListener("canplaythrough", o, !1),
        ...
        return (
          ...
          (e.prototype.refresh = function () {
            if (this._source) {
              ...
              var n = t.volume * (t.muted ? 0 : 1),
                o = e.volume * (e.muted ? 0 : 1),
                i = this._volume * (this._muted ? 0 : 1);
              b.setParamValue(this._gain.gain, i * o * n),
                b.setParamValue(this._source.playbackRate, this._speed * e.speed * t.speed);
            }
          }),
          (e.prototype.refreshPaused = function () {
            var t = this._media.context,
          ...
          (e.prototype.play = function (t) {
            ...
            (this._duration = p),
              ...
              (this._source.onended = this._onComplete.bind(this)),
              this._loop
                ? ((this._source.loopEnd = n),
                  (this._source.loopStart = e),
                  this._source.start(0, e))
                : n
                ? this._source.start(0, e, n - e)
                : this._source.start(0, e),
              this.emit("start"),
              this._update(!0),
              this.enableTicker(!0);
          ...
          (e.prototype.enableTicker = function (t) {
            n.Ticker.shared.remove(this._updateListener, this),
              t && n.Ticker.shared.add(this._updateListener, this);
          }),
          Object.defineProperty(e.prototype, "progress", {
            get: function () {
      ...
      O = (function (t) {
        function e(e) {
          ...
          return (
            ...
            ((n = t.call(this, s, r) || this).context = e),
            (n.bufferSource = i),
            (n.gain = r),
            (n.analyser = s),
            n
        ...
        return (
          ...
          Object.defineProperty(e.prototype, "script", {
            get: function () {
              return (
                this._script ||
                  ((this._script = this.context.audioContext.createScriptProcessor(e.BUFFER_SIZE)),
          ...
          (e.prototype.cloneBufferSource = function () {
            ...
            (e.buffer = t.buffer),
              b.setParamValue(e.playbackRate, t.playbackRate.value),
              (e.loop = t.loop);
            var n = this.context.audioContext.createGain();
            return e.connect(n), n.connect(this.destination), { source: e, gain: n };
          }),
      ...
      j = (function () {
        ...
        return (
          (t.prototype.init = function (t) {
            (this.parent = t),
              (this._nodes = new O(this.context)),
          ...
          (t.prototype.load = function (t) {
            this.source
              ...
              : this.parent.url
              ? this._loadUrl(t)
              : t && t(new Error("sound.url or sound.source must be set"));
          }),
      ...
      w = (function () {
        function t(t, e) {
          ...
          var n = e.complete;
          (this._autoPlayOptions = n ? { complete: n } : null),
            (this.isLoaded = !1),
            (this.isPlaying = !1),
        ...
        return (
          (t.from = function (e) {
            ...
            return (
              ...
              Object.freeze(n),
              new t(r().useLegacy ? new m() : new j(), n)
            );
          }),
          Object.defineProperty(t.prototype, "context", {
            get: function () {
          ...
          (t.prototype.play = function (t, e) {
            var n,
              o = this;
            "string" == typeof t
              ? (n = { sprite: (r = t), loop: this.loop, complete: e })
              : "function" == typeof t
              ? ((n = {}).complete = t)
              : (n = t);
            if (
              ...
              var i = n.sprite,
                r = this._sprites[i];
              (n.start = r.start + (n.start || 0)),
                (n.end = r.end),
                (n.speed = r.speed || 1),
                (n.loop = r.loop || n.loop),
                delete n.sprite;
            }
            if ((n.offset && (n.start = n.offset), !this.isLoaded))
              return new Promise(function (t, e) {
                (o.autoPlay = !0),
                  (o._autoPlayOptions = n),
                  o._preload(function (o, i, r) {
      ...
      L = (function (t) {
        function n() {
          var o = this,
            i = window,
            r = new n.AudioContext(),
            s = r.createDynamicsCompressor(),
            u = r.createAnalyser();
          return (
            u.connect(s),
            s.connect(r.destination),
            ((o = t.call(this, u, s) || this)._ctx = r),
            (o._offlineCtx = new n.OfflineAudioContext(
              1,
              2,
              i.OfflineAudioContext ? r.sampleRate : 44100
            )),
            (o._unlocked = !1),
            (o.compressor = s),
            (o.analyser = u),
            (o.events = new e.EventEmitter()),
            (o.volume = 1),
            (o.speed = 1),
            (o.muted = !1),
            (o.paused = !1),
        ...
        return (
          ...
          (n.prototype.decode = function (t, e) {
            var n = function (t) {
              ...
              o = this._offlineCtx.decodeAudioData(
                t,
                function (t) {
                  e(null, t);
                },
      ...
      A = (function () {
        ...
        return (
          (t.prototype.init = function () {
            return (
              this.supported && (this._webAudioContext = new L()),
              (this._htmlAudioContext = new E()),
              (this._sounds = {}),
          ...
          (t.prototype.add = function (t, e) {
            ...
            if (e instanceof w) return (this._sounds[t] = e), e;
          ...
          Object.defineProperty(t.prototype, "useLegacy", {
            ...
            set: function (t) {
              f.setLegacy(t),
                (this._useLegacy = t),
                (this._context =
                  !t && this.supported ? this._webAudioContext : this._htmlAudioContext);
            },
            enumerable: !1,
            configurable: !0,
          }),
      ...
      F = { HTMLAudioContext: E, HTMLAudioMedia: m, HTMLAudioInstance: y },
      C = (function () {
        function t(t, e) {
          this.init(t, e);
        }
      ...
      S = {
        ...
        EqualizerFilter: (function (t) {
          function e(n, o, i, s, u, a, c, p, h, l) {
            void 0 === n && (n = 0),
              void 0 === o && (o = 0),
              void 0 === i && (i = 0),
              void 0 === s && (s = 0),
            ...
            if (!r().useLegacy) {
              var f = [
                ...
                { f: e.F4K, type: "peaking", gain: p },
                { f: e.F8K, type: "peaking", gain: h },
                { f: e.F16K, type: "highshelf", gain: l },
              ].map(function (t) {
                var e = r().context.audioContext.createBiquadFilter();
                return (
                  (e.type = t.type),
                  b.setParamValue(e.Q, 1),
                  (e.frequency.value = t.f),
                  b.setParamValue(e.gain, t.gain),
                  e
                );
              });
              ((d = t.call(this, f[0], f[f.length - 1]) || this).bands = f), (d.bandsMap = {});
          ...
          return (
            ...
            (e.prototype.setGain = function (t, e) {
              ...
              b.setParamValue(this.bandsMap[t].gain, e);
            }),
        ...
        DistortionFilter: (function (t) {
          function e(e) {
            ...
            var n = this;
            if (!r().useLegacy) {
              var o = r().context.audioContext.createWaveShaper();
          ...
          return (
            ...
            Object.defineProperty(e.prototype, "amount", {
              ...
              set: function (t) {
                ...
                for (
                  var e, n = 44100, o = new Float32Array(n), i = Math.PI / 180, r = 0;
                  r < n;
                  ++r
                )
                  (e = (2 * r) / n - 1),
                    (o[r] = ((3 + t) * e * 20 * i) / (Math.PI + t * Math.abs(e)));
          ...
          function e(e) {
            ...
            if (!r().useLegacy) {
              var o,
                i,
                s,
                u = r().context.audioContext;
              return (
                u.createStereoPanner
                  ? (s = o = u.createStereoPanner())
                  : (((i = u.createPanner()).panningModel = "equalpower"), (s = i)),
                ((n = t.call(this, s) || this)._stereo = o),
                (n._panner = i),
                (n.pan = e),
                n
              );
          ...
          return (
            ...
            Object.defineProperty(e.prototype, "pan", {
              ...
              set: function (t) {
                (this._pan = t),
                  this._stereo
                    ? b.setParamValue(this._stereo.pan, t)
        ...
        ReverbFilter: (function (t) {
          function e(e, n, o) {
            ...
            if (!r().useLegacy)
              return (
                ((i = t.call(this, null) || this)._seconds = i._clamp(e, 1, 50)),
            ...
            (e.prototype._rebuild = function () {
              for (
                ...
                (t = this._reverse ? o - a : a),
                  (s[a] = (2 * Math.random() - 1) * Math.pow(1 - t / o, this._decay)),
                  (u[a] = (2 * Math.random() - 1) * Math.pow(1 - t / o, this._decay));
              var c = r().context.audioContext.createConvolver();
        ...
        TelephoneFilter: (function (t) {
          function e() {
            if (!r().useLegacy) {
              ...
              return (
                (n.type = "lowpass"),
                b.setParamValue(n.frequency, 2e3),
                (o.type = "lowpass"),
                b.setParamValue(o.frequency, 2e3),
                (i.type = "highpass"),
                b.setParamValue(i.frequency, 500),
                (s.type = "highpass"),
                b.setParamValue(s.frequency, 500),
                n.connect(o),
                o.connect(i),
                i.connect(s),
                t.call(this, n, s) || this
              );
            }
            t.call(this, null);
          }
    ...
    var I = {
        ...
        render: function (t, e) {
          ...
          (e = a({ width: 512, height: 128, fill: "black" }, e || {})),
            (n.width = e.width),
            (n.height = e.height);
          var i = o.BaseTexture.from(n);
          if (!(t.media instanceof j)) return i;
          var r = t.media,
            s = n.getContext("2d");
          s.fillStyle = e.fill;
          for (
            var u = r.buffer.getChannelData(0),
              c = Math.ceil(u.length / e.width),
              p = e.height / 2,
              h = 0;
            h < e.width;
            h++
          ) {
            for (var l = 1, d = -1, f = 0; f < c; f++) {
              var _ = u[h * c + f];
              _ < l && (l = _), _ > d && (d = _);
            }
            s.fillRect(h, (1 + l) * p, 1, Math.max(1, (d - l) * p));
          }
          return i;
        },
        resolveUrl: d,
        sineTone: function (t, e) {
          ...
          var n = w.from({ singleInstance: !0 });
          if (!(n.media instanceof j)) return n;
          for (
            var o = n.media,
              i = n.context.audioContext.createBuffer(1, 48e3 * e, 48e3),
